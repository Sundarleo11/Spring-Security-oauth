package com.easybyte.springsecOAuth2.config;
...
public class ProjectSecurityConfig {
  ...
  /*  @Bean
    ...
    private ClientRegistration githubClientRegistration() {
        return CommonOAuth2Provider.GITHUB.getBuilder("github").clientId("Ov23liiEqbouhvxRGll0")
                .clientSecret("a49173de0788e57cbbec28cfd0cac0ecf0e61cf3").build();
    }
